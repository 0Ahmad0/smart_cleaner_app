...
class WeatherChartScreenOld extends StatefulWidget {
  @override
  _WeatherChartScreenOldState createState() => _WeatherChartScreenOldState();
}

class _WeatherChartScreenOldState extends State<WeatherChartScreenOld> {
  bool isWeekly = true;
